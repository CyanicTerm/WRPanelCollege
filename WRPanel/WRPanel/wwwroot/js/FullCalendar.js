...
***************************************************************************** */
    ...
    function m(n, l, u, i, t, o, e, c, s, a) {
        ...
        for (u.__e = m,
            h = P; h--;)
            null != A[h] && ("function" == typeof u.type && null != A[h].__e && A[h].__e == u.__d && (u.__d = d(i, h + 1)),
                L$1(A[h], A[h]));
        if (w)
    ...
    function x$1(n, l, u, i, t, o) {
        ...
        if (void 0 !== l.__d)
            ...
            n: if (null == o || o.parentNode !== n)
                ...
                for (f = o,
                    e = 0; (f = f.nextSibling) && e < i.length; e += 2)
                    if (f == t)
                        break n;
                n.insertBefore(t, o),
                    r = o;
        ...
        try {
            n: if ("function" == typeof P) {
                if (g = u.props,
                    ...
                    null != P.getDerivedStateFromProps && (v.__s == v.state && (v.__s = c$1({}, v.__s)),
                ...
                null == r && u.__v === i.__v ? (u.__k = i.__k,
                    u.__e = i.__e) : u.__e = j$2(i.__e, u, i, t, o, r, f, s);
            (a = n.diffed) && a(u);
        } catch (l) {
            u.__v = null,
                (s || null != r) && (u.__e = e,
    ...
    function j$2(n, l, u, i, t, o, e, c) {
        ...
        if (null === _)
            ...
            if (A$1(n, d, p, t, c),
                h)
                l.__k = [];
            else if (k = l.props.children,
                m(n, Array.isArray(k) ? k : [k], l, u, i, t && "foreignObject" !== _, o, e, n.firstChild, c),
                null != o)
                for (k = o.length; k--;)
                    null != o[k] && s(o[k]);
            c || ("value" in d && void 0 !== (k = d.value) && (k !== n.value || "progress" === _ && !k) && C$1(n, "value", k, p.value, !1),
    ...
    function N(l, u, i) {
        ...
        n.__ && n.__(l, u),
            ...
            e = [],
            I$1(u, l = (!t && i || u).__k = a$1(y, null, [l]), o || r$1, r$1, void 0 !== u.ownerSVGElement, !t && i ? [i] : o ? null : u.firstChild ? f$1.slice.call(u.childNodes) : null, e, !t && i ? i : o ? o.__e : u.firstChild, t),
            T$1(e, l);
    }
    function q(n, l) {
        var u = {
    ...
    n = {
                ...
                if ((u = l.__c) && !u.__)
                    try {
                        if ((i = u.constructor) && null != i.getDerivedStateFromError && (u.setState(i.getDerivedStateFromError(n)),
                            t = u.__d),
                            null != u.componentDidCatch && (u.componentDidCatch(n),
                                t = u.__d),
                            t)
                            return u.__E = u
                    } catch (l) {
        ...
        p.prototype.setState = function (n, l) {
            ...
            u = null != this.__s && this.__s !== this.state ? this.__s : this.__s = c$1({}, this.state),
                ...
                n && c$1(u, n),
                null != n && this.__v && (l && this.__h.push(l),
                    k(this));
        }
        ,
                    ...
                    if (r.state.__e) {
                        ...
                        r.__v.__k[0] = function n(t, e, r) {
                            return t && (t.__v = null,
                                ...
                                t.__c && t.__c.__P === e && (t.__e && r.insertBefore(t.__e, t.__d),
                                    t.__c.__e = !0,
                                    t.__c.__P = r)),
                                t
                ...
                if (this.__v.__k) {
                    ...
                    this.__v.__k[0] = function n(t, e, r) {
                        return t && (t.__c && t.__c.__H && (t.__c.__H.__.forEach(function (n) {
                            ...
                            t.__c.__H = null),
                            null != (t = C({}, t)).__c && (t.__c.__P === r && (t.__c.__P = e),
                                t.__c = null),
                            t.__k = t.__k && t.__k.map(function (t) {
                                return n(t, e, r)
                            })),
    ...
    n.vnode = function (n) {
        ...
        if ("string" == typeof t) {
            for (var u in r = {},
                e) {
                var o = e[u];
                "value" === u && "defaultValue" in e && null == o || ("defaultValue" === u && "value" in e && null == e.value ? u = "value" : "download" === u && !0 === o ? o = "" : /ondoubleclick/i.test(u) ? u = "ondblclick" : /^onchange(textarea|input)/i.test(u + t) && !V(e.type) ? u = "oninput" : /^on(Ani|Tra|Tou|BeforeInp)/.test(u) ? u = u.toLowerCase() : P.test(u) ? u = u.replace(/[A-Z0-9]/, "-$&").toLowerCase() : null === o && (o = void 0),
                    r[u] = o);
            }
        ...
        t && e.class != e.className && (G.enumerable = "className" in e,
    ...
    function createDuration(input, unit) {
        ...
        if (typeof input === 'number') {
            return parseObject((_a = {},
                _a[unit || 'milliseconds'] = input,
                _a));
        }
        return null;
    }
    function parseString(s) {
        ...
        if (m) {
            ...
            return {
                ...
                milliseconds: sign * ((m[3] ? parseInt(m[3], 10) : 0) * 60 * 60 * 1000 + (m[4] ? parseInt(m[4], 10) : 0) * 60 * 1000 + (m[5] ? parseInt(m[5], 10) : 0) * 1000 + (m[6] ? parseInt(m[6], 10) : 0)),
            };
        }
        return null;
    }
    ...
    function eventApiToStore(eventApi) {
        ...
        return {
            ...
            instances: instance ? (_b = {},
                _b[instance.instanceId] = instance,
                _b) : {},
        };
    }
    ...
    function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
        ...
        if (eventSource && fetchId === eventSource.latestFetchId) {
            return __assign(__assign({}, sourceHash), (_a = {},
    ...
    var CalendarDataManager = (function () {
        ...
        CalendarDataManager.prototype._handleAction = function (action) {
            ...
            var _b = this.buildViewUiProps(calendarContext)
                ...
                , selectionConfig = _b.selectionConfig;
    ...
    var ViewContainer = (function (_super) {
        ...
        ViewContainer.prototype.render = function () {
            ...
            var classNames = ['fc-view-harness', (aspectRatio || props.liquid || props.height) ? 'fc-view-harness-active' : 'fc-view-harness-passive',];
            var height = '';
            var paddingBottom = '';
            if (aspectRatio) {
    ...
    var EventDragging = (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                var isValid = component.isValidSegDownEl(origTarget) && !elementClosest(origTarget, '.fc-event-resizer');
        ...
        TableRow.prototype.render = function () {
            ...
            return (createElement("tr", {
                ...
                return (createElement(TableCell, {
                    ...
                    bgContent: (createElement(Fragment, null, _this.renderFillSegs(highlightSegsByCol[col], 'highlight'), _this.renderFillSegs(businessHoursByCol[col], 'non-business'), _this.renderFillSegs(bgEventSegsByCol[col], 'bg-event')))
                }));
            })));
        }
            ;
    ...
    var TimeColsSlats = (function (_super) {
        ...
        TimeColsSlats.prototype.render = function () {
            ...
            }, props.tableColGroupNode, createElement(TimeColsSlatsBody, {
    ...
    function renderInnerContent(props) {
        ...
        }, props.navLinkAttrs), props.text)), props.sideText && (createElement("a", __assign({
            "aria-hidden": true,
